package com.example.animcare.MainActivityFiles.MyPets.PetDetailsActivityFiles.StudiesListFragmentFiles
...
class StudiesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment StudiesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StudiesFragment().apply {
