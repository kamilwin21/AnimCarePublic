package com.example.animcare.MainActivityFiles.MyPets.Adapters
...
import com.example.animcare.MainActivityFiles.MyPets.Class.DataPet
import com.example.animcare.MainActivityFiles.MyPets.Pet
import com.example.animcare.MainActivityFiles.MyPets.PetDetailsActivity
...
class MyPetsAdapter(val context: Context, val userPets: ArrayList<PetInList>, var isRemoving: Boolean): RecyclerView.Adapter<MyMyPetsAdapter>(){
    ...
    override fun onBindViewHolder(holder: MyMyPetsAdapter, position: Int) {
        ...
        getPhoto(imgView, petProfileIMGPath)
...
//                    notifyDataSetChanged()
                    ...
                    petType.setTextColor(oldColorPetType)
                    layout.setBackgroundColor(color)
                   // println("USERPETS: ${userPets[position].pName} || position: ${position}")
